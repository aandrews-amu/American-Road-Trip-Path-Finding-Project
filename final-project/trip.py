...
GOOGLE_MAPS_API_KEY = "AIzaSyC66FIK42qhujShvQ5ALsNFUF5jD9A8bEs"
waypoints_file = "my-waypoints-dist-dur7.tsv"
...
def mutate_agent(agent_genome, max_mutations=3):
    ...
    # can we change the way we select points? 
...
if __name__ == '__main__':
    ...
    t1 = time.time()
    total = t1-t0
    print("Total time to complete: " + str(total))
